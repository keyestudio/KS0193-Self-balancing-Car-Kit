...
How to DIY a mini balance car on your own? This balance car kit is based on Arduino development platform. We mainly use Keyestudio V4.0 (Black) Main Control Board as core and balance shield with built-in MPU-6050 as drive board to test the car body posture. 
