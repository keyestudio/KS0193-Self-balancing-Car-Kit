...
Arduino development platform. We mainly use Keyestudio V4.0 Main Control
...
| 19      | Keyestudio V4.0 Main Control Board                                    | 1            | ![](media/732861e91fb925bddae4f6445ecba503.png) |
...
Go to screw the V4.0 control board onto the 4pcs M3\*10MM copper pillars mounted
on the Acrylic plate with 3pcs M3\*6MM round-head screws.

![](media/3b2b69724aeaaf40334572d46cb089a3.jpeg)

Then stack the keyestudio balance shield onto V4.0 control board. And plug the
...
When it comes to using the V4.0 as core of our robot, the V4.0 is the best board
to get started with electronics and coding. If this is your first experience
tinkering with the platform, the V4.0 is the most robust board you can start
playing with.
...
The control pins of V4.0 are all brought out as female header on the shield; the
...
When you get the V4.0 development board, first you should install the software
...
package（![1](media/f50a31a59716594afbd7c2254cfd521e.png)）, open driver folder
...
In the previous, we have introduced the driver installation of V4.0 development
board.
...
buzzer. To be specific, button is controlled by pin D13 on V4.0; active buzzer
is controlled by pin D11 on V4.0.
...
right motor’s direction by pin D8 D12 on V4.0; speed is controlled by pin D10.
The left motor’s direction by pin D7 D6 on V4.0; speed is controlled by pin D9.
...
Now, we will use the built-in internal timer (timer2) of V4.0 board. Calculate
